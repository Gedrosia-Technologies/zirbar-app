...
<head>
  ...
  <title>Account Detail Print</title>
  <style>
    .clearfix:after {
      content: "";
      display: table;
...
<?php
        // $grand_total_adah += $row->adah ;
        // $grand_total_wasol += $row->wasol ;
?>
...
?>
  ...
  <h1>Account Details ({{$accounttitle}} - {{$accountdescription}})</h1>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="total">@if($row->type == 0)
            <?php
                    $grand_total_credit += $row->amount;
        ...
        <tr>
          ...
          <td class="total"><b>{{number_format($grand_total_credit)}}</b></td>
          <td class="total"><b>{{number_format($grand_total_debit)}}</b></td>
